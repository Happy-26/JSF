...
public class InitDate {
    ...
    public void hqlInsert() {
        Transaction transaction = session.beginTransaction();
        String hql = "insert into student (id, name, gender, birth, password, major, classes) values(?0, ?1, ?2, ?3,?4,?5,?6)";
        SQLQuery query = session.createSQLQuery(hql);
        query.setParameter(0, "12019242442");
        query.setParameter(1, "尚奎");
        query.setParameter(2, "男");
        query.setParameter(3, "2001/08/15");
        query.setParameter(4, "e10adc3949ba59abbe56e057f20f883e");
        query.setParameter(5, "计算机科学与技术");
        query.setParameter(6, "一班");
        query.executeUpdate();
        transaction.commit();
    }
